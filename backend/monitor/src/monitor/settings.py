...
class MonitorSettings(ValkeySettings):
    ...
    heartbeat_timeout: int = Field(default=300, description="Max age in seconds for heartbeat before unhealthy")
    ws_url: str = Field(default="ws://api:8000/ws", description="WebSocket URL for synthetic client check")
