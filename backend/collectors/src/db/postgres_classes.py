...
class GeoCache(Base):
    ...
    def __repr__(self):
        return (
            f"<GeoCache(callsign={self.callsign}, locator={self.locator}, lat={self.lat}, lon={self.lon}, "
...
class DxheatRaw(Base):
    ...
    __table_args__ = (UniqueConstraint("date", "time", "spotter", "frequency", "dx_call", name="uc_dxheat_raw"),)

    def __repr__(self):
        return (
            f"<DxheatRaw(id={self.id}, number={self.number}, spotter={self.spotter}, frequency={self.frequency}, "
...
class HolySpot(Base):
    ...
    comment = Column(Text)
    __table_args__ = (UniqueConstraint("date", "time", "spotter_callsign", "dx_callsign", name="uc_holy_spots"),)
...
class SpotWithIssue(Base):
    ...
    dx_continent = Column(Text)
    comment = Column(Text)
    __table_args__ = (UniqueConstraint("date", "time", "spotter_callsign", "dx_callsign", name="uc_spots_with_issues"),)

    def __repr__(self):
        return (
            f"<SpotsWithIssues(id={self.id}, date={self.date}, time={self.time}, date_time={self.date_time}, mode={self.mode}, missing_mode={self.missing_mode}, band={self.band}, frequency={self.frequency}, "
            f"spotter_callsign={self.spotter_callsign}, spotter_locator={self.spotter_locator}, "
            f"spotter_lat={self.spotter_lat}, spotter_lon={self.spotter_lon}, spotter_country={self.spotter_country}, , spotter_continent={self.spotter_continent}, "
            f"dx_callsign={self.dx_callsign}, dx_locator={self.dx_locator}, dx_lat={self.dx_lat}, dx_lon={self.dx_lon}, dx_country={self.dx_country}, dx_continent={self.dx_continent}, comment={self.comment},>"
        )
