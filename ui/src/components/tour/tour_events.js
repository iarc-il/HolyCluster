...
export const TOUR_SELECT_SIDE_PANEL_TAB_EVENT = "holycluster:tour-select-side-panel-tab";
export const TOUR_SELECT_SETTINGS_TAB_EVENT = "holycluster:tour-select-settings-tab";
