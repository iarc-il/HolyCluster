            ...
            <div className="absolute top-0 z-40 right-0 flex justify-end mr-2 pt-2 xs:pt-4 gap-2 xs:gap-4 mb-2">
                ...
                <div className="flex flex-col items-end gap-1">
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <svg height="32" width="32" viewBox="0 0 16 16" fill={colors.buttons.utility}>
                    ...
                    <button
                        onClick={() => set_map_controls(state => (state.show_cq_zones = !state.show_cq_zones))}
                        className="flex items-center justify-center relative"
                        title={map_controls.show_cq_zones ? "Hide CQ Zones" : "Show CQ Zones"}
                    >
                        <span
                            className="w-8 h-8 flex items-center justify-center text-2xl leading-none font-semibold"
