    ...
    return (
        ...
        >
            <div className="flex flex-row p-3">
                ...
                <div>
                    <ThemeSection section="theme" />
                    <ThemeSection section="buttons" />
                    <ThemeSection section="table" />
            ...
            <div className="flex justify-around items-end pb-2">
                <Button>
                    <a
                        ...
                        href={`data:Application/octet-stream,${encodeURIComponent(JSON.stringify(colors))}`}
                    >
                        Download
                    </a>
                </Button>
