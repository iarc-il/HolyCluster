...
export function ProfilesProvider({ children }) {
    ...
    const [temporary_profile_store, set_temporary_profile_store] = useState(null);

    const persisted_profile_store = useMemo(
        () => sanitize_profile_store(stored_profile_store, fallback_profile_data),
        [stored_profile_store, fallback_profile_data],
    );
    const profile_store = temporary_profile_store ?? persisted_profile_store;
    ...
    function start_temporary_profile() {
        set_temporary_profile_store({
            ...
            profiles: [
                {
                    name: TOUR_PROFILE_NAME,
                    data: create_default_profile_data(),
                },
            ],
        });
    }
    ...
    function update_active_profile_data(value_or_setter) {
        const target_profile_name = active_profile.name;
