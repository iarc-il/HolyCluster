...
const country_color_indices_earth = [
    2, 4, 1, 3, 4, 1, 5, 4, 3, 4, 3, 6, 6, 7, 2, 5, 1, 7, 0, 7, 5, 4, 0, 5, 5, 6, 6, 1, 5, 7, 2, 0,
    1, 3, 7, 0, 0, 3, 3, 7, 2, 0, 1, 6, 7, 1, 4, 6, 0, 1, 4, 4, 0, 1, 3, 5, 5, 3, 2, 3, 6, 2, 2, 4,
    4, 2, 3, 3, 6, 6, 4, 5, 5, 6, 1, 4, 0, 7, 4, 5, 7, 6, 5, 3, 5, 6, 7, 6, 7, 4, 0, 5, 6, 7, 1, 0,
    1, 2, 5, 7, 3, 7, 1, 1, 0, 0, 3, 2, 0, 2, 4, 0, 1, 7, 2, 1, 2, 2, 5, 5, 3, 6, 7, 2, 3, 6, 5, 4,
    0, 6, 4, 3, 5, 2, 2, 6, 1, 4, 2, 6, 5, 1, 4, 2, 4, 3, 3, 4, 1, 5, 7, 7, 0, 4, 7, 7, 6, 7, 7, 1,
    3, 0, 1, 5, 0, 2, 3, 3, 0, 2, 5, 1, 0, 2, 6, 4, 0, 6, 7, 2, 6, 3, 2, 3, 5, 0, 1, 4, 4, 0, 5, 6,
    7, 0, 1, 6, 7, 2, 1, 3, 4, 5, 6, 2, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 3, 5, 6, 7, 0, 1,
    2, 3, 4, 5, 6, 7, 0, 1, 4, 2, 3, 4, 0, 5, 5, 6, 1, 6, 7, 0, 1, 7, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3,
    4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 0, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2,
    3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2,
    3, 4, 1, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 3, 2, 2, 3, 4, 5,
];

if (typeof console !== "undefined") {
    dxcc_map.features.forEach((f, i) => {
        console.log(`${i}: ${f.properties.dxcc_name ?? "null"} -> ${country_color_indices_earth[i]}`);
    });
}

export { country_color_indices, country_color_indices_earth };
